...
var playerAttack = randomNumber(7, 10);
var playerMoney = 10;
...
var startGame = function() {
  ...
  var endGame = function() {
    ...
    if (playerHealth > 0) {
      window.alert("Great job, you have survived the game! Your score is " + playerMoney + ".");
    }
    else {
    ...
    var shopOptionPrompt = window.prompt(
      ...
      switch (shopOptionPrompt) {
        ...
        case "refill":
          ...
          window.alert("Refilling player's health by 20 for 7 bitcoins.");
        ...
        case "upgrade":
          ...
          window.alert("Upgrading player's attack by 6 for 7 bitcoins.");
